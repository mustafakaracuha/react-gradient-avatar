...
import { FaPaintBrush, FaLightbulb, FaBolt } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 flex flex-col items-center p-6">
      <header className="w-full max-w-4xl text-center mb-10 pt-6">
        ...
        <p className="text-gray-600 max-w-lg mx-auto text-lg">
          Modern, özelleştirilebilir ve güzel gradient avatarlar için React
          bileşeni
        </p>
      ...
      {/* Feature highlights */}
      <div className="flex justify-center gap-6 w-full max-w-4xl mb-10">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex items-center gap-4 transition-transform hover:scale-105 hover:shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Özelleştirilebilir</h3>
              <p className="text-gray-500 text-sm">
                Boyut, şekil ve renk ayarları
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex items-center gap-4 transition-transform hover:scale-105 hover:shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Hafif</h3>
              <p className="text-gray-500 text-sm">
                Minimalist ve performanslı
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex items-center gap-4 transition-transform hover:scale-105 hover:shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Kolay</h3>
              <p className="text-gray-500 text-sm">Basit entegrasyon</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">Kare</span>
                    </button>
                  </div>
                </div>
        ...
        <span>Mustafa Karaçuha</span>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>
                    <strong>title:</strong> Avatar için isim (gerekli)
                  </li>
                  <li>
                    <strong>size:</strong> Avatar boyutu pikseller cinsinden
                    (varsayılan: 40)
                  </li>
                  <li>
                    <strong>shape:</strong> "circle" veya "square" (varsayılan:
                    "circle")
                  </li>
                  <li>
                    <strong>color:</strong> Özel renk kodu (varsayılan: otomatik
                    gradient)
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white w-full rounded-xl shadow-lg border border-gray-100 p-8 mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 flex flex-col items-center hover:shadow-lg transition-all">
                ...
                <span className="mt-4 text-lg font-medium">Varsayılan</span>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 flex flex-col items-center hover:shadow-lg transition-all">
                ...
                <span className="mt-4 text-lg font-medium">Kare Şekli</span>
                <code className="mt-2 text-sm bg-gray-50 p-3 rounded-md w-full text-center border border-gray-100">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 flex flex-col items-center hover:shadow-lg transition-all">
                ...
                <span className="mt-4 text-lg font-medium">Özel Renk</span>
                <code className="mt-2 text-sm bg-gray-50 p-3 rounded-md w-full text-center border border-gray-100">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 flex flex-col items-center hover:shadow-lg transition-all">
                ...
                <span className="mt-4 text-lg font-medium">Avatar Grubu</span>
                ...
                <div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow flex items-center gap-4 border border-gray-200">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Geliştirici</div>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">Dün</div>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">
                      Bu kütüphane harika, projemizde kullanıyoruz!
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="w-full max-w-4xl mx-auto mb-8 px-8 py-10 border border-gray-200 rounded-xl bg-gradient-to-b from-purple-100 shadow-lg">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 text-center text-sm mb-4">
            Takip edin ve yeni projelerimi keşfedin!
          </p>
          ...
          <p className="text-gray-400 text-xs mt-6">
            Tasarım ve geliştirme © 2025 Mustafa Karaçuha
          </p>
        </div>
      </footer>
    </div>
